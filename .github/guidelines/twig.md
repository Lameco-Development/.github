# Twig Guidelines
- Don't use hardcoded content. Use existing variables to populate content dynamically. You may refer to existing templates for examples of how to do this. If this fails you may use dummy variables and fields for illustration purposes.
